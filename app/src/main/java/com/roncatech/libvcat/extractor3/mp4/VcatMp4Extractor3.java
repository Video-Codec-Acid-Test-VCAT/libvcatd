...
import static com.roncatech.libvcat.extractor3.mp4.BoxParser.parseTraks;
import static com.roncatech.libvcat.extractor3.mp4.Sniffer.BRAND_HEIC;
import static com.roncatech.libvcat.extractor3.mp4.Sniffer.BRAND_QUICKTIME;
...
@UnstableApi
public final class VcatMp4Extractor3 implements Extractor, SeekMap {

  /**
   * Creates a factory for {@link VcatMp4Extractor3} instances with the provided {@link
   * SubtitleParser.Factory}.
   */
  public static ExtractorsFactory newFactory(SubtitleParser.Factory subtitleParserFactory) {
    return () -> new Extractor[] {new VcatMp4Extractor3(subtitleParserFactory)};
  }
  ...
  public static final ExtractorsFactory FACTORY =
      () ->
          new Extractor[] {
            new VcatMp4Extractor3(SubtitleParser.Factory.UNSUPPORTED, FLAG_EMIT_RAW_SUBTITLE_DATA)
          };
  ...
  /**
   * @deprecated Use {@link #VcatMp4Extractor3(SubtitleParser.Factory)} instead
   */
  @Deprecated
  public VcatMp4Extractor3() {
   ...
   *     extraction.
   */
  public VcatMp4Extractor3(SubtitleParser.Factory subtitleParserFactory) {
    this(subtitleParserFactory, /* flags= */ 0);
  }

  /**
   * @deprecated Use {@link #VcatMp4Extractor3(SubtitleParser.Factory, int)} instead
   */
  @Deprecated
  public VcatMp4Extractor3(@Flags int flags) {
   ...
   */
  public VcatMp4Extractor3(SubtitleParser.Factory subtitleParserFactory, @Flags int flags) {
  ...
  private void processMoovAtom(ContainerBox moov) throws ParserException {
    ...
    int trackIndex = 0;
    String containerMimeType = MimeTypeResolver.getContainerMimeType(trackSampleTables);
  ...
  private boolean shouldSeekToAxteAtom(@Nullable Metadata mdtaMetadata) {
    ...
    if ((flags & FLAG_READ_AUXILIARY_TRACKS) != 0) {
      ...
      MdtaMetadataEntry axteAtomOffsetMetadata =
          MetadataUtil.findMdtaMetadataEntryWithKey(mdtaMetadata, MdtaMetadataEntry.KEY_AUXILIARY_TRACKS_OFFSET);
  ...
  private void maybeSetDefaultSampleOffsetForAuxiliaryTracks(Metadata metadata) {
    ...
    MdtaMetadataEntry samplesInterleavedMetadata =
        MetadataUtil.findMdtaMetadataEntryWithKey(metadata, MdtaMetadataEntry.KEY_AUXILIARY_TRACKS_INTERLEAVED);
  ...
  private List<@C.AuxiliaryTrackType Integer> getAuxiliaryTrackTypesForAuxiliaryTracks(
    ...
    MdtaMetadataEntry trackTypesMetadata =
        checkStateNotNull(
            MetadataUtil.findMdtaMetadataEntryWithKey(metadata, MdtaMetadataEntry.KEY_AUXILIARY_TRACKS_MAP));
